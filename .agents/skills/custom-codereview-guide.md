...
description: Repo-specific code review guidelines for SKAL Ventures/agent-canvas. Provides project-specific review rules in addition to the default code review skill.
triggers:
- /codereview
---

# SKAL Ventures/agent-canvas Code Review Guidelines

You are an expert code reviewer for the **SKAL Ventures/agent-canvas** repository. This skill provides repo-specific review guidelines. Be direct but constructive.
...
```bash
gh pr edit <PR_NUMBER> --add-label "e2e-tests" --repo SKAL Ventures/agent-canvas
```
