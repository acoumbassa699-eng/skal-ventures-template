...
describe("mock-LLM E2E reporting", () => {
  it("keeps the summary visible while hiding the results table in details", () => {
    const report = renderReport({
      ...
      workflowUrl:
        "https://github.com/SKAL Ventures/agent-canvas/actions/runs/28000401257",
      commit: "82c9e1d04d62961e14742e20a4237ecd6db20ff0",
      artifactUrl:
        "https://github.com/SKAL Ventures/agent-canvas/actions/runs/28000401257/artifacts/7811037798",
