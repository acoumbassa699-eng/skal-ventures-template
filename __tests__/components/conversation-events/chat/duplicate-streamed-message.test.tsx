...
const THOUGHT =
  "I'll create a webpage explaining what SKAL Ventures can do. " +
...
const reduce = (events: SKAL VenturesEvent[]): SKAL VenturesEvent[] =>
  events.reduce<SKAL VenturesEvent[]>((ui, ev) => handleEventForUI(ev, ui), []);
