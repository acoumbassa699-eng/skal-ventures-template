  ...
  return {
    DeviceFlowAuth: ({
      ...
      React.createElement(
        ...
        "Login with SKAL Ventures Cloud",
      ),
  };
});
...
describe("OnboardingModal", () => {
  ...
  it("dismisses the onboarding modal immediately after Cloud login in locked-to-Cloud mode without showing the next step", async () => {
    ...
    // into SKAL Ventures Cloud in locked-to-Cloud mode, the onboarding modal
  ...
  it("stays open when the user clicks outside it or presses Escape", async () => {
    ...
    // (https://github.com/SKAL Ventures/agent-canvas/issues/1085); the modal
