...
describe("ChooseAgentStep", () => {
  ...
  it("renders all four agent options with SKAL Ventures marked selected by default", () => {
    renderStep();
  ...
  it("persists agent_kind:'openhands' and advances on Next when SKAL Ventures is selected", async () => {
