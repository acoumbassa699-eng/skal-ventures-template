...
// host-classifier `isSKAL VenturesCloudHost` (which the backend form uses to infer
...
describe("ManageBackendsModal", () => {
  ...
  it("shows disconnected for a reachable backend below the compatible version floor", async () => {
    ...
    ).toHaveTextContent("SKAL Agent Canvas requires agent-server 1.28.0 or newer");
  });
