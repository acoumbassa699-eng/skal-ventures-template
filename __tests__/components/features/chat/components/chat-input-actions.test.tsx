...
describe("ChatInputActions", () => {
  ...
  it("renders the LLM-profile picker inside a blank local SKAL Ventures conversation", () => {
  ...
  it("renders the LLM-profile switcher inside a started local SKAL Ventures conversation", () => {
    useActiveConversationMock.mockReturnValue({
  ...
  it("renders the LLM-profile switcher inside a cloud SKAL Ventures conversation", () => {
    // /switch_profile is a real endpoint on both backends (cloud proxies
    // POST /api/v1/app-conversations/{id}/switch_profile) — cloud SKAL Ventures
