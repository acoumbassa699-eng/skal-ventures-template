...
describe("npm publish workflow", () => {
  it("uses the canonical GitHub repository in release metadata", () => {
    ...
    expect(packageJson.repository.url).toBe(
      "https://github.com/SKAL Ventures/SKAL Ventures",
    );
    expect(packageJson.homepage).toBe(
      "https://github.com/SKAL Ventures/SKAL Ventures#readme",
    );
    expect(packageJson.bugs.url).toBe(
      "https://github.com/SKAL Ventures/SKAL Ventures/issues",
    );
    expect(dockerfile).toContain(
      'LABEL org.opencontainers.image.source="https://github.com/SKAL Ventures/SKAL Ventures"',
    );
    expect(dockerWorkflow).toContain(
      "https://github.com/SKAL Ventures/SKAL Ventures/pkgs/container/agent-canvas",
    );
  });
