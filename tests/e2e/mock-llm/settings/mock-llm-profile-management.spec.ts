 ...
 *
 *   3. SKAL Ventures provider hidden base_url preservation:
...
test.describe("same-model profile identity", () => {
  ...
  test("chat header shows the correct profile when two profiles share the same model", async ({
    ...
    await test.step("profile switcher shows the correct profile name", async () => {
      // In a local SKAL Ventures conversation the chat input renders the
...
// ═══════════════════════════════════════════════════════════════════════
// Test 3 — SKAL Ventures provider hidden base_url preservation
// ═══════════════════════════════════════════════════════════════════════

test.describe("SKAL Ventures provider hidden base_url preservation", () => {
  // The public SKAL Ventures provider model remains the profile identity, but a
  ...
  test("re-saving an SKAL Ventures profile from Basic view preserves hidden base_url", async ({
    page,
    request,
  }) => {
    // ── Setup: create a public SKAL Ventures profile with a custom base_url through
